...
async def test():
    ...
    await db.add_product(
        ...
        15,
        "Discover our signature smooth, rich instant coffee. Coffee connoisseurs will appreciate"
        "the well-rounded taste and rich aroma in every cup. Our expertly crafted blend is great"
        "for all coffee drinking occasions, whenever you want to make a moment special. "
        "So why not relax, enjoy the now and savour the distinctive taste of this premium blend.",
    )
    await db.add_product(
        "food",
        "🍒 Oziq-ovqat",
